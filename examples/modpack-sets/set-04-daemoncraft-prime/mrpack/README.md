...
**Required infrastructure** — Fabric API, Mod Menu, Cloth Config.
...
1. Open Modrinth App / Prism Launcher → DaemonCraft instance → Mods.
2. "+ Add Mod" → search **Iris Shaders** → install for 1.21.11.
3. Download **Complementary Reimagined** shader pack (free).
4. Hit Play, then in-game Options → Video Settings → Shader Packs →
   "Open Shader Pack Folder" and drop the Complementary zip.
5. Select it in the list and apply.
